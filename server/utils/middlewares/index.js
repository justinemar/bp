...
const AccountHelper       = require("../lib/account");
...
module.exports = {
    ...
    sendVerification: (req, res) => {
        ...
        const verification_token = AccountHelper.setToken({email: email})
    ...
    verifyEmail: (req, res, next) => {
        jwt.verify(req.params.token, process.env.KEY1, function(err, decoded) {
            if(err) {
                res.status(401).json({
